...
The **Crypto** extension, developed by [**Query.Farm**](https://query.farm), adds cryptographic hash functions and HMAC (Hash-based Message Authentication Code) calculation and cryptographically secure random byte generation to DuckDB.
